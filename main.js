...
import * as THREE from "/three/build/three.module.js" assert { type: 'css' };
import { OrbitControls } from '/three/examples/jsm/controls/OrbitControls.js' assert { type: 'css' };
